import ProjectKatakana from './ProjectKatakana.json'; // Replace <path_to_projectKatakana.json> with the actual path to your 'projectKatakana.json' file
